...
public class LoadDatLichAdapter extends RecyclerView.Adapter<LoadDatLichAdapter.MyViewHolder>{
        ArrayList<VacXin> newVacXin;

        public LoadDatLichAdapter(ArrayList<VacXin> newVacXin) {
        ...
        public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.mai_layout_rec_datlich, parent, false);
